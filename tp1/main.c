 ...
 */
//Modification de Moussa
//Modification de Augustin
int main(int argc, char** argv) {
	...
	float rateComparaison = comparison(value_to_root,root);

	// Print out the results.
	printf("Result = %f\n", root);
   printf("le taux de comparaison entre la racine réelle et la racine approximative donnée par la methode Newton est: %f\n",rateComparaison);
